...
class RegistroGoogleScreen extends StatefulWidget {
  @override
  _RegistroGoogleScreenState createState() => _RegistroGoogleScreenState();
}

class _RegistroGoogleScreenState extends State<RegistroGoogleScreen> {
  final _nameController = TextEditingController();
  final _passwordController = TextEditingController();
  final _confirmPasswordController = TextEditingController();

  // Variable para manejar el estado del género seleccionado
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Requisitos de contraseña con diseño de checks
                Wrap(
                  spacing: 20,
                  runSpacing: 8,
                  children: [
                    _buildRequirementItem("Debe tener mayúsculas", _reqMayusculas, () => setState(() => _reqMayusculas = !_reqMayusculas)),
                    _buildRequirementItem("Debe tener un símbolo", _reqSimbolo, () => setState(() => _reqSimbolo = !_reqSimbolo)),
                    _buildRequirementItem("Debe tener 8 caracteres", _req8Caracteres, () => setState(() => _req8Caracteres = !_req8Caracteres)),
                    _buildRequirementItem("Debe tener un número", _reqNumero, () => setState(() => _reqNumero = !_reqNumero)),
                  ],
                ),
  ...
  // Widget para el selector de género (Masculino/Femenino)
  ...
  // Botón individual de opción de género
  ...
  // Widget para los requisitos de la contraseña
  Widget _buildRequirementItem(String text, bool isChecked, VoidCallback onTap) {
    return GestureDetector(
      onTap: onTap,
      child: Row(
        mainAxisSize: MainAxisSize.min,
